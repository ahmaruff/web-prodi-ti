...
<div class="flex flex-col items-center w-full h-screen md:flex-row">
    <div class="h-screen bg-center bg-no-repeat bg-cover md:w-1/2" style="background-image: url('/assets/images/maba-putih.jpg')">
...
<div class="" id="visi">
    <h1 class="px-24 py-24 text-xl font-bold text-center bg-white md:text-4xl">
        {{$visi['visi']}}
    </h1>
    <div class="w-full py-24 bg-gray-100">
        <h2 class="text-4xl font-bold text-center text-purple-600">
            Misi
        </h2>
        <ul class="flex flex-col items-center justify-center">
            @foreach ($misi as $item_misi)
            <li class="w-full px-10 py-8 mx-16 my-4 font-semibold bg-white shadow-lg rounded-2xl md:w-2/3 hover:bg-purple-600 hover:text-white hover:transition-colors hover:ease-in-out hover:scale-105 hover:shadow-xl">
                {{$item_misi['misi']}}
            </li>
            @endforeach
        </ul>
    ...
    <div class="w-full py-24 bg-white">
        ...
        <ul class="flex flex-col items-center justify-center">
            ...
            <li class="w-full px-10 py-8 mx-10 my-4 font-semibold text-white bg-purple-500 shadow-lg rounded-2xl md:w-2/3 hover:transition-colors hover:ease-in-out hover:scale-105 hover:shadow-xl">
                {{$item_tujuan['tujuan']}}
            </li>
            @endforeach
        </ul>
