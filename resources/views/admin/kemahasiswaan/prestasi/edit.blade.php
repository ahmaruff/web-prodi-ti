            ...
            <form action="{{route('admin.prestasi.update', $prestasi->id)}}" method="post" enctype=multipart/form-data>
                ...
                <div class="flex justify-between w-full my-4 space-x-4">
                    <label for="juara" class="block w-1/2">
                        ...
                        <input type="text" name="juara" id="" value="{{$prestasi->juara}}" placeholder="Juara 1" required
                    ...
                    <label for="nama_kompetisi" class="block w-1/2">
                        ...
                        <input type="text" name="nama_kompetisi" id="" value="{{$prestasi->nama_kompetisi}}" placeholder="Hackathon 2023" required
                        class="block w-full mt-1 bg-gray-100 border-transparent rounded-md focus:border-purple-500 focus:bg-white focus:ring-0 dark:bg-dark-eval-2"
                        >
                ...
                <div class="flex justify-between w-full my-4 space-x-4">
                    <label for="tanggal" class="block w-1/2">
                        ...
                        <input type="date" name="tanggal" id="" value="{{$prestasi->tanggal}}" required
                        class="block w-full mt-1 bg-gray-100 border-transparent rounded-md focus:border-purple-500 focus:bg-white focus:ring-0 dark:bg-dark-eval-2"
                        >
                    ...
                    <label for="tingkatan" class="block w-1/2">
                        ...
                        class="block w-full mt-1 bg-gray-100 border-transparent rounded-md focus:border-purple-500 focus:bg-white focus:ring-0 dark:bg-dark-eval-2"
                        >
                            <option value="{{$prestasi->tingkatan}}">{{$prestasi->tingkatan}}</option>
                ...
                <div class="flex justify-between w-full my-4 space-x-4">
                    ...
                    <label for="penyelenggara" class="block w-1/2">
                        ...
                        <input type="text" name="penyelenggara" id="" value="{{$prestasi->penyelenggara}}" placeholder="Dicoding ID" required
                        class="block w-full mt-1 bg-gray-100 border-transparent rounded-md focus:border-purple-500 focus:bg-white focus:ring-0 dark:bg-dark-eval-2"
                        >
                ...
                <label for="title" class="block mt-3">
                    ...
                    <textarea name="deskripsi" id="" class="w-full mt-1 min-h-[7rem] bg-gray-100 border-transparent rounded-md dark: focus:border-purple-500 focus:bg-white focus:ring-0 dark:bg-dark-eval-2">{{$prestasi->deskripsi}}</textarea>
