    ...
    <x-slot name="header">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <h2 class="text-xl font-semibold leading-tight">
                Edit Data Akreditasi | {{$akreditasi->id}}
            </h2>
        ...
        <div>
            <form action="{{route('admin.akreditasi.update', $akreditasi->id)}}" method="post" enctype="multipart/form-data">
                ...
                <label for="prodi" class="block my-4">
                    ...
                    <input type="text" name="prodi" id="" value="{{$akreditasi->prodi}}" placeholder="Teknik Informatika" required
                ...
                <div class="flex my-4 space-x-8">
                    <label for="peringkat" class="block w-full">
                        ...
                        >
                            <option value="{{$akreditasi->peringkat}}">{{$akreditasi->peringkat}}</option>
                    ...
                    <label for="no_sk" class="block w-full">
                        ...
                        <input type="text" name="no_sk" id="" value="{{$akreditasi->no_sk}}" placeholder="No SK" required
                        class="block w-full mt-1 bg-gray-100 border-transparent rounded-md dark: focus:border-purple-500 focus:bg-white focus:ring-0 dark:bg-dark-eval-2"
                        >
                ...
                <div class="flex my-4 space-x-8">
                    <label for="tgl_terbit" class="block w-full">
                        ...
                        <input type="date" name="tgl_terbit" id="" value="{{$akreditasi->tgl_terbit}}" placeholder="2020" required
                        class="block w-full mt-1 bg-gray-100 border-transparent rounded-md dark: focus:border-purple-500 focus:bg-white focus:ring-0 dark:bg-dark-eval-2"
                        >
                    ...
                    <label for="tgl_kadaluarsa" class="block w-full">
                        ...
                        <input type="date" name="tgl_kadaluarsa" id="" value="{{$akreditasi->tgl_kadaluarsa}}" placeholder="No SK" required
                        class="block w-full mt-1 bg-gray-100 border-transparent rounded-md dark: focus:border-purple-500 focus:bg-white focus:ring-0 dark:bg-dark-eval-2"
                        >
                ...
                <div class="flex my-4 space-x-8">
                    <label for="status" class="block w-full">
                        ...
                        class="block w-full mt-1 bg-gray-100 border-transparent rounded-md focus:border-purple-500 focus:bg-white focus:ring-0 dark:bg-dark-eval-2"
                        >
                            <option value="{{$akreditasi->status}}">{{$akreditasi->status}}</option>
