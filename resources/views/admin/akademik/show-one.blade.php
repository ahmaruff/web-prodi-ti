    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <div>"
                ...
                <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center justify-end space-x-1 font-semibold">
                        ...
                        <div class="px-4 py-2 bg-gray-100 rounded-none text-amber-500 dark:bg-dark-eval-2">
                            <a href="{{ route('admin.akademik.info-akademik.edit',[$data->id]) }}">Click to edit</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-purple-500 mt-4">
                <canvas id="the-canvas" class="w-full border-2" data-link="{{url('/storage/uploads/akademik/'.$data->dokumen)}}"></canvas>
            </div>
        </div>
    </div>
    @pushOnce('scripts')
