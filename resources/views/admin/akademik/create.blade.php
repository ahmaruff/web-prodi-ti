<x-app-layout>
    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <div class="">
            <form action="{{route('admin.akademik.info-akademik.store')}}" method="post" enctype=multipart/form-data
            x-data="{content : {html : '', json : ''}}"
            >
                {{ csrf_field() }}
                <label for="title" class="block my-4">
                    <span class="">Judul</span>
                    <input type="text" name="judul" id="" value="" placeholder="Kerja Praktek" required
